...
import img_1 from "../../../../public/assets/01.jpg"
...
function page() {
  ...
  return (
    <div className="bg-[#f2f2f3] gap-10 flex flex-col xl:gap-14 justify-start items-center py-10 lg:py-36 px-2 lg:px-60">
      ...
      {/*Room Card */}
      <div className="">
      <h2 className='text-black text-2xl mb-6 text-center'>Your Order</h2>
      <div className="bg-white p-4 w-full rounded ">
        <h3 className='text-black text-xl mb-4'>Single Room</h3>
        <Image src={img_1} />
        <h4 className='text-gray-600 text-lg mt-4'>Dates : 20/06/2024 - 26/06/2024</h4>
        <h4 className='text-gray-600 text-lg mb-4' >6 Nights</h4>

        <p className='text-black text-xl mb-10'>Total : $2000</p>
        <button className='underline text-red-600'>Remove</button>
      </div>
      </div>

      <Button  startIcon={<BiSolidDish />} href='' className='text-white bg-[#b99470]  px-4 py-2 hover:bg-[#b8895b]  hover:text-white rounded '>Confirm Order</Button>
